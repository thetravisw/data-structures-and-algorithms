package Whiteboard18_FindMax;

import Whiteboard16_Fizzbuzz_Tree.tree.BinaryTree;
import Whiteboard16_Fizzbuzz_Tree.tree.TreeNode;
...
public class find_maximum_value {
    ...
    private static int find_maximum_value(TreeNode node){
        Queue<Whiteboard16_Fizzbuzz_Tree.tree.TreeNode> qq = new LinkedList<>();
        qq.add(node);
